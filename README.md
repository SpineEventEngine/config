 ...
 * `.claude/` — Claude Code configuration:
    ...
    * `commands/*.md` — slash commands: `/bump-version`, `/bump-gradle`, `/java-to-kotlin`,
      `/update-copyright`, `/move-files`, `/write-docs`, `/run-build`. Each wraps the
      corresponding skill in `.agents/skills/`.
